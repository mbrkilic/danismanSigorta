...
export default function FinalCTA() {
  ...
  return (
    <section
      id="iletisim"
      ref={ref}
      className="py-24 lg:py-32 cta-gradient relative overflow-hidden noise-bg"
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="reveal reveal-delay-1 font-display text-4xl lg:text-6xl text-white leading-tight">
            Bizimle <em className="not-italic text-[#6ee7b7]">iletişime</em>{" "}
            geçin.
          </h2>
        </div>
        ...
        <div className="reveal reveal-delay-2 flex flex-col lg:flex-row bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl">
          ...
          <div className="w-full lg:w-2/5 p-8 lg:p-12 bg-white/5 border-r border-white/10">
            ...
            <div className="space-y-10">
              ...
              <div className="flex items-start gap-5 group">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">+90 (342) 232 88 52</p>
                  <p className="text-white font-medium">+90 (342) 232 88 54</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-5 group">
                <div className="w-12 h-12 rounded-2xl bg-[#00A86B]/20 flex items-center justify-center text-[#6ee7b7] border border-[#00A86B]/30 group-hover:bg-[#00A86B] group-hover:text-white transition-all duration-300">
                  {/* Boyut ve hizalaması düzeltilmiş adres SVG'si */}
                  <svg
                    width="20"
                    height="20"
                    fill="none"
            ...
            <div className="mt-16 pt-8 border-t border-white/5">
              <p className="text-white/30 text-xs italic leading-relaxed">
                "Size en uygun sigorta teklifini hazırlamak için uzman
                ekibimizle her an yanınızdayız."
              </p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-3/5 p-8 lg:p-12">
            ...
            <p className="text-white/50 text-sm mb-8">
              Bilgilerinizi bırakın, uzmanımız sizi hemen arasın.
            </p>

            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-white/50 text-[10px] font-bold uppercase tracking-widest mb-2 ml-1">
                    Ad *
                  </label>
                  <input
                    className={inp}
              ...
              {result && (
                <div
                  className={`text-sm font-medium px-4 py-3 rounded-xl ${status === "success" ? "bg-[#00A86B]/15 text-[#6ee7b7]" : "bg-red-500/15 text-red-300"}`}
                >
                  {result}
                </div>
              )}
